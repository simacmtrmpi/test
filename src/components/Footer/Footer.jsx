...
const Footer = () => {
  ...
  return (
    <div>
<footer className="flex max-w-7xl mx-auto flex-row flex-wrap items-center justify-center gap-y-6 gap-x-12 border-t border-blue-gray-50 py-6 text-center md:justify-between">
